...
class MockCoachTest {
    ...
    @Nested
    class ConstructorWithWhensAndVerifies {

        @Test
        void success() {
            Whens whens = new Whens(mock1, when1, mock2, when2);
            Verifies verifies = new Verifies(mock1, verify1, mock2, verify2);
            new MockCoach(whens, verifies);
        }
        ...
        @Test
        void whenMocksAreInCircleChain_ThenSuccess() {
            Whens whens = new Whens(mock1, when1, mock2, when2, mock1, when3);
            Verifies verifies = new Verifies(mock1, verify1, mock2, verify2, mock1, verify3);
            new MockCoach(whens, verifies);
        }

        @Test
        void whenWhensAreNull_ThenThrowIllegalArgumentException() {
            String expectedMessage = "Whens cannot be null!";

            Verifies verifies = new Verifies(mock1, when1, null, when2);

            IllegalArgumentException actualException = assertThrows(
                    IllegalArgumentException.class,
                    () -> new MockCoach(null, verifies)
            );
        ...
        @Test
        void whenVerifiesAreNull_ThenThrowIllegalArgumentException() {
            String expectedMessage = "Verifies cannot be null!";

            Whens whens = new Whens(mock1, when1, null, when2);

            IllegalArgumentException actualException = assertThrows(
                    IllegalArgumentException.class,
                    () -> new MockCoach(whens, null)
            );
        ...
        @Test
        void whenMocksInWhensAndVerifiesAreNotEqual_ThenThrowIllegalArgumentException() {
            String expectedMessage = "Whens and Verifies must use the same mocks in the same order! Please check the passed in Whens and Verifies objects.";

            Whens whens = new Whens(mock1, when1, mock2, when2);
            Verifies verifies = new Verifies(mock1, when1, mock(Object.class), when2);
        ...
        void whenMocksContainsInteger_ThenThrowIllegalArgumentException() {
            ...
            Whens whens = new Whens(mock1, when1, 2, when2);
            Verifies verifies = new Verifies(mock1, when1, 2, when2);
        ...
        void whenMocksContainsCharacter_ThenThrowIllegalArgumentException() {
            ...
            Whens whens = new Whens(mock1, when1, 'B', when2);
            Verifies verifies = new Verifies(mock1, when1, 'B', when2);
        ...
        void whenMocksContainsString_ThenThrowIllegalArgumentException() {
            ...
            Whens whens = new Whens(mock1, when1, "Second Mock", when2);
            Verifies verifies = new Verifies(mock1, when1, "Second Mock", when2);
        ...
        void whenMocksContainsEnum_ThenThrowIllegalArgumentException() {
            ...
            Whens whens = new Whens(mock1, when1, MockEnum.SECOND, when2);
            Verifies verifies = new Verifies(mock1, when1, MockEnum.SECOND, when2);
        ...
        void whenMocksInACyclicGraphThatIsNotACircleChain_ThenThrowIllegalArgumentException() {
            ...
            // Duplicate mock2 in method parameters
            Whens whens = new Whens(mock1, when1, mock2, when2, mock2, when3);
            Verifies verifies = new Verifies(mock1, when1, mock2, when2, mock2, when3);
